...
#pragma warning disable 0618
        ...
        static public NntpDateTime Parse(string value)
        {
            ...
            if (!m.Success)
            {
                ...
                throw new FormatException(NntpErrorMessages.ERROR_47);
            }
            try
            {
            ...
            {
                throw new FormatException(NntpErrorMessages.ERROR_47, ex);
            }
        }
        ...
        public string ToString(string format)
        {
            ...
            throw new ArgumentException(NntpErrorMessages.ERROR_46);
        }
    }
}
